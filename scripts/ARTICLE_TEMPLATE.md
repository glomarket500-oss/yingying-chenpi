...
| 编号 | 铁律 | 检查方法 |
|------|------|----------|
| 1 | **四幕场景结构** | 開場 → 客人到訪 → 滢滢姐講解 → 離開之前 |
| 2 | **人物对话推动** | 滢滢姐 + 客人，全文对话占比 > 40% |
| 3 | **当天热点融入** | 自然带入，不标签框 |
| 4 | **FAQ 段落式** | 至少 3-5 条，**不用** tip-box 包裹 |
| 5 | **时间精确到秒** | `xxxx年x月x日 xx:xx:xx` |
| 6 | **错别字** | 人名统一使用「滢滢」，禁止使用其他异体写法 |
...
| 11 | **滢滢姐70后輩分铁律** | 见下方「👵 滢滢姐年纪与輩分」专节，每篇写稿前必对 |

---

## 👵 滢滢姐年纪与輩分（铁律第11条细则）

> **滢滢姐是70后。** 所有文章的人物关系必须符合以下輩分，写稿前必对：

| 对方身份 | 正确关系 | 写法示例 |
|----------|----------|----------|
| 年轻客人、小孩（如阿囡） | 滢滢姐是长辈 | 对方叫她「滢滢姐」，她用长辈口吻 |
| 老一辈师傅（如九妹、黄建社、高子祥的父辈） | 滢滢姐是晚辈/请教者 | 她请教、旁听，不能写成同辈指点 |
| 同龄师傅（如高子祥1984年生） | 平辈交流 | 互相切磋，不能写成师徒 |
| 绝不允许 | — | 小孩直呼其名、老人叫她「姐」、她叫老人「弟妹」 |
...
keywords: "新会陈皮,陈皮收藏,陈皮年份,陈皮价格,陈皮储存,滢滢姐,新会天马"
author: "滢滢"
date: "2026-09-XX"
...
1. **生成/写稿** → 放 `C:\Users\a\Desktop\MianAI知识库\MianAI知识库\vault\滢滢姐讲陈皮故事\草稿\`
2. **直接发布** → 脚本完成后移动到 `C:\Users\a\Desktop\MianAI知识库\MianAI知识库\vault\滢滢姐讲陈皮故事\已发布\`
3. **运行发布**：
   ```bash
...
- **草稿箱：** `C:\Users\a\Desktop\MianAI知识库\MianAI知识库\vault\滢滢姐讲陈皮故事\草稿\`
- **已发布：** `C:\Users\a\Desktop\MianAI知识库\MianAI知识库\vault\滢滢姐讲陈皮故事\已发布\`